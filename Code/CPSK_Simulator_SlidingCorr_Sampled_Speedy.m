...
%   AUTHOR:  Ramin Vali                                % 
%                                                                       %
%   DESCRIPTION: This Simulator simulates a CPSK system that uses a 
...
%
%2/12/07
% We need more efficiency in this new version of the code so we do the
% following: 1.We replace the xcorr by a multiplier and accumulator at the
% right moment( same thig just might be faster.
%2. we just generate on CPSK message and modulation set, we keep that and
%keep adding noise rather than doing the whole thing over again for
%everything.
%                                                                       %
%-----------------------------------------------------------------------%
...
%------------------ Produce Chaotic sequences and message for the only time ---------------------------
...
legend(num2str(Rs),'samples ','Theoretical CPSK - AWGN channel');
