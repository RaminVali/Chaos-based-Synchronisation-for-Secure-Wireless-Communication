% this file is just taken for the sake of noise calculation for the new
% multisample chaotic synchroniser. Do nto use anything else out of this
% one.
...
%======================= VARIABLES TO CHANGE ============================
trials = 10^3;          % Balance between accuracy and speed: 10^3-10^5
...
Offset = 563;            % Chip offset (delay between rx and tx)
users = 1;              % Additional users
SNR_dB = 8;           % Chip Eb/No
%========================================================================
...
% grid on;
% figure;
% plot(Z_th_store, prob_detections(1:length(Z_th_store)), 'b');
% hold on;
% plot(Z_th_store, prob_failure(1:length(Z_th_store)), 'b');
% grid on;
